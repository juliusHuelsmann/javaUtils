 ...
 * and changing the current position in list etc.
 *
...
public class List<Type> implements Serializable {
   ...
   */
  public final void goToElement(final Element<Type> xelemCurrent) {
    elemCurrent = xelemCurrent;
  }
  ...
  public final List<Type> subList() {
    ...
    List<Type> ls = new List<Type>(log);
    Element<Type> elemcurrSaved = elemCurrent;
   ...
   */
  public final void replace(final Type xnewContent) {
...
//      isSorted = false;
      ...
      //set the new content
      elemCurrent.setContent(xnewContent);
    }
  }
   ...
   * @param xnewContent contains the content which is to be inserted.
   */
  public final void insertBehind(final Type xnewContent) {
...
//    isSorted = false;
   ...
   * @param xnewContent contains the content which is to be inserted.
   */
  public final void insertInFrontOf(final Type xnewContent) {
    ...
    if (isEmpty()) {
      ...
      elemNew = new Element<Type>(xnewContent, elemCurrent,
  ...
  public final void remove() {
    ...
    if (!isEmpty() && !isBehind() && !isInFrontOf()) {
      ...
      log.warning("remove null item out of list: Perform"
   ...
   * @param xnewContent contains the content which is to be inserted.
   */
  public final void insertAfterHead(final Type xnewContent) {
    
    //go to the first item of the list and insert in front of it the new
    //content
    toFirst();
    insertInFrontOf(xnewContent);
  }
   ...
   * @param xnewContent contains the content which is to be inserted.
   */
  public final void insertAtTheEnd(final Type xnewContent) {

    //go to the last item of the list and insert behind it the new content
    toLast();
    insertBehind(xnewContent);
  }
   ...
   */
  public final boolean find(final Type xtype) {
  ...
  public final void printIndex() {
    ...
    final Element<Type> oldCurrent = elemCurrent;
    System.out.println("\n\nprint\n");
    toFirst();
    while (!isBehind()) {
